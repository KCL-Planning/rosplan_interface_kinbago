...
namespace KCL_rosplan {
    ...
    void RPPersonInteraction::dispatchCallback(const rosplan_dispatch_msgs::ActionDispatch::ConstPtr& msg) {
        ...
        if(0==msg->name.compare("greet_person")) {
            ...
            // greet the person
            runCommand("espeak -v en-sc -s 150 \"Hi, my name is Dorian, and will be your guide today. You will have to take care of pressing the elevator buttons. And open all the doors along the way. The rest is up to me. Just follow me and I will take you to your destination. \"");
            ...
            runCommand("espeak -v en-sc -s 150 \"You have reached your destination. I will go back to the reception, bye bye. \"");
